...
export function VariantSelector({
  ...
  return options.map((option) => (
    <dl className="mb-8" key={option.id}>
      <dt className="mb-4 text-sm uppercase tracking-wide">Available sizes</dt>
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                {
                  'cursor-default ring-2 ring-[#3E54A4]': isActive,
                  'ring-1 ring-transparent transition duration-300 ease-in-out hover:scale-110 hover:ring-[#3E54A4] ':
