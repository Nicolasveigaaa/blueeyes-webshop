  ...
  return (
    <>
      ...
      <section className="flex h-full w-full flex-col lg:flex-row">
        <div className="relative order-2 h-[400px] w-full overflow-hidden sm:h-[500px] md:h-[600px] lg:sticky lg:top-0 lg:order-1 lg:h-[100vh] lg:w-1/2">
          <CardAnimation>
            <Image
              src={Bg1}
                ...
                <CardAnimation>
                  ...
                  {firstProduct.images[1] && (
                    <Image
                      ...
                      alt={`image of model wearing ${firstProduct.title}`}
                      fill
                      className={`product-image-back absolute left-0 top-0 h-full w-full object-cover opacity-0 transition-opacity duration-300 group-hover:opacity-100 ${firstProduct.availableForSale ? '' : 'grayscale'}`}
                    />
                  )}
                </CardAnimation>
            ...
            >
              <CardAnimation>
                <Image
                  ...
                  className={`object-cover ${secondProduct.availableForSale ? '' : 'grayscale'}`}
                  fill
                />
                ...
                {secondProduct.images[1] && (
                  <Image
                    ...
                    alt={`image of model wearing ${secondProduct.title}`}
                    fill
                    className={`product-image-back absolute left-0 top-0 h-full w-full object-cover opacity-0 transition-opacity duration-300 group-hover:opacity-100 ${secondProduct.availableForSale ? '' : 'grayscale'}`}
                  />
                )}
              </CardAnimation>
